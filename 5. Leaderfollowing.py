...
task = ['LeaderFollowing', (SHAPE, DST)]

#! Main function start
example_running(task, example_running(task, robots_info, NODE_IDX_LIST, SENSOR_ANGLES, ACHIEVED_CONDITION_DISTANCE, BLENDING_STATE, OBST_DETECT_MARGIN, RUNNING_TIME_LIMIT, enableAvoidObstacle, ROTATION = None), NODE_IDX_LIST, SENSOR_ANGLES, ACHIEVED_CONDITION_DISTANCE, BLENDING_STATE, OBST_DETECT_MARGIN, RUNNING_TIME_LIMIT, enableAvoidObstacle)